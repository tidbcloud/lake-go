...
func waitForData(ctx context.Context, dc *LakeConn, response *QueryResponse) (*QueryResponse, error) {
...
func (dc *LakeConn) newNextRows(ctx context.Context, resp *QueryResponse) (rows *nextRows, err error) {
